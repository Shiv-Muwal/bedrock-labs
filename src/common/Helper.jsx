...
export const CONTINUE_SLIDER = [
  { text: "TourGame", images: { cardOne: tour_game_ui, cardTwo: tour_branding } },
  { text: "Aperture" , images: { cardOne: aperture_ui, cardTwo: aperture_branding } },
  { text: "Aperture" , images: { cardOne: aperture_ui, cardTwo: aperture_branding } },
  { text: "Social Tensor", images: { cardOne: social_sensor, cardTwo: social_tensor } },
  { text: "Niche Tensor" , images: { cardOne: niche_ui, cardTwo: niche_branding } },
  { text: "THELASTONE" , images:{cardOne: thelastone_branding, cardTwo:''} },
  { text: "INFINI", images: { cardOne: infini_ui, cardTwo: infini_branding } },
  { text: "TourGame", images: { cardOne: tour_game_ui, cardTwo: tour_branding } },
  { text: "CyberConnect", images: { cardOne: cyber_ui, cardTwo: cyber_branding } },
