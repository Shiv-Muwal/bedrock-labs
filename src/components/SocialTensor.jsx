...
const SocialTensor = () => {
  ...
  return (
    <div className="position-relative overflow-hidden"
      ...
      <div className="w-100 position-absolute top-0 bottom-0 bg-black d-flex align-items-center justify-content-center overflow-y-scroll scroll_height" style={{ height: "100%" }}>
        ...
        <div className="d-flex d-md-none position-absolute top-0 flex-column gap-4 pt_24 pb_65 align-items-center justify-content-center mb-5 ">
