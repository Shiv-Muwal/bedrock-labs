          ...
          <div className="slider_container">
            <div className="slider_parent">
              {CONTINUE_SLIDER.map((obj, i) => (
                <span onMouseEnter={Mouse_Over}
                  onMouseLeave={Mouse_out} className="slider_item mb-0 text_lg opacity_20 text-white text-center text-nowrap slider_text cursor_pointer fst-italic" key={i}>
                  {obj.text}
                </span>
              ))}
            </div>
